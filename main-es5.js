...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.login = function (email, password) {
                    ...
                    this.auth.emailLogin(email, password)
                        ...
                        .catch(function (err) { return _this.warningMessage = 'Wrong Email/Password'; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                ...
                SignupComponent.prototype.signup = function (name, email, password, repassword) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CourseComponent = /** @class */ (function () {
                function CourseComponent(ks) {
                    ...
                    this.courseForm.valueChanges.subscribe(function () { return _this.done = false; });
                ...
                CourseComponent.prototype.ngOnInit = function () {
                    ...
                    if (course) {
                        ...
                        if (data.type === 2) {
                            ...
                            var sameDate = interval.sameDate, entireDay = interval.entireDay;
                ...
                CourseComponent.prototype.onSubmit = function (form) {
                    ...
                    if (form.valid) {
                        ...
                        if (config.type === 2) {
                            var interval = config.interval = { sameDate: this.sameDate, entireDay: this.entireDay };
                        ...
                        (function (a) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var data, createdCourse, _a, _b;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        data = Object.assign({ name_lowercase: a.name.toLowerCase() }, a);
                                        if (!this.course) return [3 /*break*/, 2];
                                        return [4 /*yield*/, this.course.ref.update(data)];
                                    case 1:
                                        _c.sent();
                                        return [3 /*break*/, 5];
                                    case 2: return [4 /*yield*/, this.ks.generateCourse(data)];
                                    case 3:
                                        createdCourse = _c.sent();
                                        _a = this;
                                        _b = {};
                                        return [4 /*yield*/, createdCourse.get()];
                                    case 4:
                                        _a.course = (_b.data = (_c.sent()).data(),
                                            _b.key = createdCourse.id,
                                            _b.ref = this.ks.referenceToAngularReference(createdCourse),
                                            _b);
                                        this.ngOnInit();
                                        _c.label = 5;
                        ...
                        }); })(config).catch(function (err) { return alert('Error adding/updating Course' + err); })
                            .finally(function () { _this.loading = false; _this.done = true; });
                        function updateTime(date, time) {
                            var holder = /(.+):(.+) (.+)/.exec(time);
                ...
                CourseComponent.prototype.changeCircle = function () {
                    var type = this.courseForm.value.type;
                    switch (type) {
                        case 0:
                ...
                CourseComponent.prototype.changeForm = function (val) {
                    var form = this.courseForm;
                    var value = val ? val : form.value;
                    ['startDate', 'endDate', 'startTime', 'endTime']
                        .forEach(function (control) { return form.removeControl(control); });
                    if (value.type === 2) {
                        date('start');
                        if (!this.entireDay || !this.sameDate) {
                            if (this.entireDay) {
                ...
                CourseComponent.prototype.downloadKey = function (course) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(ks, fs, as) {
                    var _this = this;
                    this.ks = ks;
                    this.fs = fs;
                    this.as = as;
                    ...
                    this.keys = this.transform(this.ks.getKeys(function (ref) { return ref.limit(_this.limit).orderBy('name'); }));
                }
                HomeComponent.prototype.transform = function (ob) {
                    var _this = this;
                    this.loading = true;
                    return ob.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (actions) {
                        console.log(actions);
                        _this.loading = false;
                        return actions.map(function (item) {
                            return Object.assign({ ref: _this.ks.referenceToAngularReference(item.payload.doc.ref) }, item.payload.doc.data(), { data: item.payload.doc.data(), key: item.payload.doc.id, latest: _this.fs.getLatest(item.payload.doc.ref).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (a) {
                                    if (a.length !== 0) {
                                        var _a = a[0].payload.doc.data(), Submitted = _a.Submitted, Name = _a.Name, QnLabel = _a.QnLabel, Answer = _a.Answer;
                                        return Submitted
                ...
                HomeComponent.prototype.search = function (search) {
                    var _this = this;
                    var nameKey = 'name_lowercase';
                    this.keys = this.transform(this.ks.getKeys(function (ref) { return ref.where(nameKey, '>=', search).where(nameKey, '<=', search + '\uf8ff').limit(_this.limit).orderBy(nameKey); }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (a) { return a; })));
                };
                HomeComponent.prototype.hideCourse = function () {
                    this.courseDetails = false;
                };
                HomeComponent.prototype.showCourse = function (item) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SliderComponent = /** @class */ (function () {
                ...
                SliderComponent.prototype.onChange = function (value) {
                    this.valueOnChange.emit(value);
                };
                SliderComponent.prototype.displayWith = function (value) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ViewPieChartComponent = /** @class */ (function () {
                function ViewPieChartComponent() {
                    this.unique = function (value, index, self) {
                        return self.indexOf(value) === index;
                    };
                }
                ViewPieChartComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.data.Answers.map(function (a) { return a[find]; }).filter(this.unique)
                        .sort(sort)
                        .forEach(function (unique) {
                        var numberOfData = _this.data.Answers.filter(function (a) { return a[find] === unique; }).length;
                        var dataText = "(" + numberOfData + ")";
                        _this.pieChartData.push(numberOfData);
                        if (_this.data.type === 'TL') {
                            switch (unique) {
                                case 'codeGreen':
                                    _this.pieChartColors[0].backgroundColor.push('#77dd77');
                                    _this.pieChartLabels.push('CodeGreen' + dataText);
                                    break;
                                case 'codeOrange':
                                    _this.pieChartColors[0].backgroundColor.push('#ffb347');
                                    _this.pieChartLabels.push('CodeOrange' + dataText);
                                    break;
                                case 'codeRed':
                                    _this.pieChartColors[0].backgroundColor.push('#ff6961');
                                    _this.pieChartLabels.push('CodeRed' + dataText);
                                    break;
                            }
                        }
                        else {
                            _this.pieChartLabels.push(unique + dataText);
                            if (_this.data.type !== 'FR') { // MCQ
                                var Code = _this.data.Answers.find(function (a) { return a[find] === unique; }).Code;
                                if (Code === 'codeGreen') {
                                    _this.pieChartColors[0].backgroundColor.push('green');
                                }
                                else {
                                    _this.pieChartColors[0].backgroundColor.push('red');
                                }
                            }
                        }
                    });
                };
                return ViewPieChartComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ViewComponent = /** @class */ (function () {
                function ViewComponent(fd, router, route, ks) {
                    this.fd = fd;
                    this.router = router;
                    this.route = route;
                    this.ks = ks;
                ...
                ViewComponent.prototype.ngOnInit = function () {
                    ...
                    this.getCourse();
                    this.fd.getData(this.keyRef, function (ref) { return ref.orderBy('Submitted', 'desc').limit(1); })
                        ...
                        if (d.length === 0) {
                            ...
                            _this.hasData = true;
                            _this.setupDate(_this.dateToDateInfo(d[0].Submitted.toDate()));
                            _this.$dateData = _this.fd.getData(_this.keyRef, function (ref) { return ref.orderBy('Submitted'); })
                                ...
                                var dateArray = data
                                    .map(function (item) { return _this.transformData(item); })
                                    .map(function (_a) {
                                    var Submitted = _a.Submitted;
                                    return Submitted.toDateString();
                                })
                                    .filter(_this.unique)
                                    .map(function (text) { return _this.dateToDateInfo(new Date(text)); });
                                return dateArray;
                            }));
                        }
                    });
                };
                ViewComponent.prototype.dateToDateInfo = function (date) {
                ...
                ViewComponent.prototype.setupDate = function (date) {
                    if (!this.setDateBoo) {
                ...
                ViewComponent.prototype.getCourse = function () {
                    var _this = this;
                    this.keyRef.valueChanges()
                        ...
                        if (!i) {
                            ...
                            _this.course = _this.keyRef.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (item) {
                                if (!item.payload.exists) {
                                    alert('Course has been deleted/not found');
                                    _this.router.navigate(['/dashboard']);
                                    return;
                                }
                                _this.hasCourse = true;
                                return {
                                    ref: _this.keyRef,
                ...
                ViewComponent.prototype.refreshDate = function () {
                    var _this = this;
                    var date = this.selectedDate.date;
                    var dateHolder = new Date(date);
                    dateHolder.setDate(dateHolder.getDate() + 1);
                    var endDate = dateHolder;
                    this.getBarData(function (ref) {
                        _this.query = ref.where('Submitted', '>', date).where('Submitted', '<', endDate).orderBy('Submitted');
                        return _this.query;
                    });
                };
                ViewComponent.prototype.changeDate = function (d) {
                    var _this = this;
                    if (this.selectedDate.text !== (d ? d.text : null)) {
                        this.hideSlider = true;
                        this.displayQns = [];
                        this.displayStudents = [];
                        var date_1 = (this.selectedDate = d || this.selectedDate).date;
                        var dateHolder = new Date(date_1);
                        dateHolder.setDate(dateHolder.getDate() + 1);
                        var endDate_1 = dateHolder;
                        this.getBarData(function (ref) {
                            _this.query = ref.where('Submitted', '>', date_1).where('Submitted', '<', endDate_1).orderBy('Submitted');
                            return _this.query;
                        });
                    }
                };
                ViewComponent.prototype.getBarData = function (r) {
                    var _this = this;
                    this.bardata = this.fd.getDataState(this.keyRef, (r ? r : function (ref) { return ref; })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (action) {
                        var allData = action.map(function (item) {
                            return Object.assign({ ref: _this.ks.referenceToAngularReference(item.payload.doc.ref) }, _this.transformData(item.payload.doc.data()));
                        });
                        _this.timeData = allData.map(function (_a) {
                            var Submitted = _a.Submitted;
                            return Submitted;
                        });
                        if (_this.timeData.length > 1) {
                            _this.hideSlider = false;
                            if (_this.timeEnd) {
                                allData = allData.filter(function (_a) {
                                    var Submitted = _a.Submitted;
                                    return Submitted <= _this.timeEnd;
                                });
                            }
                        }
                        else {
                        ...
                        return _this.transformForBarChart(allData);
                    }));
                };
                ViewComponent.prototype.transformForBarChart = function (dataArray) {
                    var _this = this;
                    var uniqueQuestions = dataArray.map(function (_a) {
                        var QnLabel = _a.QnLabel;
                        return QnLabel;
                    }).filter(this.unique).map(function (QnLabel) {
                        var Answers = dataArray.filter(function (data) { return data.QnLabel === QnLabel; });
                        var type = !Answers.find(function (s) { return s.Code || s.Answer; })
                            ? 'MS' // Milestone
                            : !Answers.find(function (s) { return s.Code; })
                                ? 'FR' // Free Response
                                : !Answers.find(function (s) { return s.Answer; })
                                    ? 'TL' // Traffic Light
                                    : '';
                        var chart = [];
                        return {
                            QnLabel: QnLabel, Answers: Answers, type: type, chart: chart,
                            displayInfo: _this.displayQns.find(function (qn) { return qn === QnLabel; }) ? true : false,
                            displayStudent: _this.displayStudents.find(function (qn) { return qn === QnLabel; }) ? true : false
                        };
                    });
                    var max = Math.max.apply(Math, uniqueQuestions.map(function (_a) {
                        var Answers = _a.Answers;
                        return Answers.length;
                    }));
                    this.barStats(max);
                    uniqueQuestions.forEach(function (og) {
                        var Answers = og.Answers, type = og.type;
                        var sum = 0;
                        switch (type) {
                            case 'MS':
                            ...
                            case 'FR':
                                ...
                                break;
                            case 'TL':
                                var TLorder_1 = ['codeGreen', 'codeOrange', 'codeRed'];
                                og.chart = Answers.map(function (_a) {
                                    var Code = _a.Code;
                                    return Code;
                                })
                                    .filter(_this.unique)
                                    .sort(function (a, b) { return TLorder_1.indexOf(a) - TLorder_1.indexOf(b); })
                                    .map(function (Code) {
                                    switch (Code) {
                                        case 'codeGreen':
                                            return Object.assign({ color: '#77dd77' }, transform(Answers.filter(function (codeData) { return codeData.Code === Code; })));
                                        case 'codeOrange':
                                            return Object.assign({ color: '#ffb347' }, transform(Answers.filter(function (codeData) { return codeData.Code === Code; })));
                                        case 'codeRed':
                                            return Object.assign({ color: '#ff6961' }, transform(Answers.filter(function (codeData) { return codeData.Code === Code; })));
                                    }
                                }).reverse();
                                break;
                            default:
                                var order_1 = ['codeGreen', 'codeRed'];
                                og.chart = Answers.map(function (_a) {
                                    var Code = _a.Code;
                                    return Code;
                                })
                                    .filter(_this.unique)
                                    .sort(function (a, b) { return order_1.indexOf(a) - order_1.indexOf(b); })
                                    .map(function (Code) {
                                    switch (Code) {
                                        case 'codeGreen':
                                            return Object.assign({ color: 'green' }, transform(Answers.filter(function (codeData) { return codeData.Code === Code; })));
                                        case 'codeRed':
                                            return Object.assign({ color: 'red' }, transform(Answers.filter(function (codeData) { return codeData.Code === Code; })));
                                    }
                                }).reverse();
                        }
                ...
                ViewComponent.prototype.barStats = function (max) {
                    this.max = max;
                    ...
                    this.barMax = [];
                    for (var index = 0; index <= splitTo; index++) {
                        this.barMax.push(Math.round((max * (index / splitTo)) * 100) / 100);
                    }
                };
                ViewComponent.prototype.allDates = function () {
                    ...
                    this.getBarData(function (ref) { return ref.orderBy('Submitted'); });
                };
                ViewComponent.prototype.transformData = function (item) {
                    var data = item;
                    data.Submitted = data.Submitted.toDate();
                    return data;
                };
                ViewComponent.prototype.displayMore = function (QnLabel) {
                    var index = 0;
                    if (this.displayQns.find(function (qn, i) {
                        if (QnLabel === qn) {
                            index = i;
                            return true;
                        }
                ...
                ViewComponent.prototype.displayStudent = function (QnLabel) {
                    var index = 0;
                    if (this.displayStudents.find(function (qn, i) {
                        if (QnLabel === qn) {
                            index = i;
                            return true;
                        }
                ...
                ViewComponent.prototype.sliderOnChange = function (value) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthGuardService = /** @class */ (function () {
                ...
                AuthGuardService.prototype.canActivate = function (next) {
                    ...
                    return this.authService.$authenticated.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (boo) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                function AuthService(af, router) {
                    ...
                    this.router = router;
                    this.authState = null;
                    af.authState.subscribe(function (a) {
                        return _this.authState = a;
                    });
                }
                ...
                Object.defineProperty(AuthService.prototype, "$authenticated", {
                    get: function () {
                        return this.af.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (user) { return user !== null; }));
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                AuthService.prototype.reRoute = function () {
                ...
                AuthService.prototype.emailSignUp = function (email, password, name) {
                    return this.af.auth.createUserWithEmailAndPassword(email, password)
                        .then(function (user) { return user.user.updateProfile({ displayName: name }); });
                };
                AuthService.prototype.emailLogin = function (email, password) {
                    return this.af.auth.signInWithEmailAndPassword(email, password);
                };
                AuthService.prototype.login = function (email, password) {
                    this.af.auth.signInWithEmailAndPassword(email, password).catch(function (err) { return console.log(err); });
                };
                return AuthService;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FiredataService = /** @class */ (function () {
                function FiredataService(fs) {
                    this.fs = fs;
                }
                FiredataService.prototype.getLatest = function (docref) {
                    return this.fs.doc(docref).collection('data', function (ref) { return ref.orderBy('Submitted', 'desc').limit(1); }).snapshotChanges();
                };
                FiredataService.prototype.getData = function (key, ref) {
                    return key.collection('data', ref).valueChanges();
                };
                FiredataService.prototype.getDataState = function (key, ref) {
                    return key.collection('data', ref).snapshotChanges();
                };
                FiredataService.prototype.toDoc = function (uid, key) {
                    return this.fs.collection('uid').doc(uid).collection('keys').doc(key);
                };
                return FiredataService;
            }());
            FiredataService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KeyService = /** @class */ (function () {
                function KeyService(fs, as) {
                    this.fs = fs;
                    this.as = as;
                    this.fileName = 'dbInfo';
                    this.database = this.fs.collection('uid');
                }
                KeyService.prototype.setkey = function (key) {
                    this.key = key;
                };
                KeyService.prototype.getKey = function () {
                    return this.key;
                };
                KeyService.prototype.getKeys = function (ref) {
                    return this.database.doc(this.as.currentUserId).collection('keys', ref).snapshotChanges();
                };
                KeyService.prototype.referenceToAngularReference = function (ref) {
                    return this.fs.doc(ref.path);
                };
                KeyService.prototype.generateCourse = function (config) {
                ...
                KeyService.prototype.updatetest = function (doc) {
                    return doc.update({ name: 'asdasadasdd' });
                };
                KeyService.prototype.getKeyData = function (doc) {
                    return doc.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (item) {
                        return Object.assign({ id: item.payload.id }, item.payload.data());
                    }));
                };
                KeyService.prototype.generateAPIKeyFile = function (doc) {
